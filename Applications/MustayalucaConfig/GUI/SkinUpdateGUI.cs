...
//                    if (MustayalucaConfig.patchUtilityRunUnattended)
//                    {
//                      upgradeProcess.Arguments += " /unattended";
//                    }
                    
//                    if (MustayalucaConfig.patchUtilityRestartMP)
//                    {
//                      upgradeProcess.Arguments += " /restartmp ";
//                      upgradeProcess.Arguments += MustayalucaConfig.smpSettings.mpSetAsFullScreen ? "true" : "false";
//                      upgradeProcess.Arguments += " \"" + Path.Combine(Path.Combine(SkinInfo.mpPaths.Mustayalucapath, "Media"), "splashscreen.png") + "\"";
//                    }
...
//                  MustayalucaConfig.manualInstallNeeded = true;
//                }
//              }
//              else
//              {
...
//      get
//      {
//        return (int)MustayalucaConfig.SMPScreenID.SMPSkinUpdate;
//      }
//      set
//      {
//      }
...
//    {
//      return Load(GUIGraphicsContext.Skin + @"\MustayalucaConfig_update.xml");
//    }
...
//          GUIPropertyManager.SetProperty("#Mustayaluca.Revisions", MustayalucaConfig.theRevisions);
//        }
//        catch (Exception ex)
//        {
...
//        cmc_ChangeLog.Visible = false;
//        btDoUpdate.Visible = false;
//        if (MustayalucaConfig.manualInstallNeeded)
//        {
