...
namespace MustayalucaConfig
{
  public class TVConfig : GUIWindow
  {
    ...
    private void ApplyConfigurationChanges()
    {
      ...
      if (requiresRestart)
      {
        MustayalucaConfig.ShowRestartMessage(GetID, Translation.TVMenu);
      }
    }
    #endregion
    ...
    public override int GetID
    {
      get
      { 
        return (int)MustayalucaConfig.SMPScreenID.SMPTVConfig; 
      }    
    }

    public override bool Init()
    {      
      return Load(GUIGraphicsContext.Skin + @"\MustayalucaConfig_tv.xml");
    }
