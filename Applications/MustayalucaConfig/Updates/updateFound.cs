...
//      changlogForm.Text = "Mustayaluca Skin Update - Change log";
...
//      else
//        changeLog.Text = "\n          Error During ChangeLog Download\n\n          You can chose to try and install the patch from here or alternatively download the patch from the Mustayaluca\n          Site and try a manual update.";
...
//        int patchCnt = 1;
//        MustayalucaConfig.theRevisions = "Patch(s): ";
//        foreach (updateCheck.patches thePatch in updateCheck.patchList)
//        {
...
//            MustayalucaConfig.theRevisions = MustayalucaConfig.theRevisions + thePatch.patchVersion.ToString() + " / ";
//          else
//            MustayalucaConfig.theRevisions = MustayalucaConfig.theRevisions + thePatch.patchVersion.ToString();
//          patchCnt++;
//        }
