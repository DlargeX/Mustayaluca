...
//        else
//          xmlURL = "http://Mustayaluca.googlecode.com/svn/trunk/SkinUpdate/SkinUpdate.xml";

//        // Read the file
//        reader = new XmlTextReader(xmlURL);
//        reader.MoveToContent();
//        if ((reader.NodeType == XmlNodeType.Element) && (reader.Name == "Mustayaluca"))
//        {
//          while (reader.Read())
//          {
...
//      try
//      {
//        string xmlURL = SkinInfo.mpPaths.Mustayalucapath + "Mustayaluca.version.xml";
//        reader = new XmlTextReader(xmlURL);
//        reader.MoveToContent();
//        string elementName = "";
...
//        downloadForm.Text = "Download and Install Mustayaluca Update r" + thePatch.patchVersion.ToString();
