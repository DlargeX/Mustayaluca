      ...
      switch (i)
      {
        case 0:
          ...
          if (menItem.hyperlink == "196299")
            ...
            if (menItem.hyperlink == formMustayalucaEditor.musicSkinID && menItem.hyperlinkParameter != "false")
          ...
          if (menItem.subMenuLevel1ID > 0)
            rawXML.AppendLine("<ondown>" + (menItem.subMenuLevel1ID + 1).ToString() + "</ondown>");
          else
            rawXML.AppendLine("<ondown>" + (menItem.id + 700).ToString() + "</ondown>");

          if (menItem.showMostRecent == displayMostRecent.movies && cbMostRecentMovPics.Checked)
            rawXML.AppendLine("<onup>91919991</onup>");
          else if (menItem.showMostRecent == displayMostRecent.tvSeries && cbMostRecentTvSeries.Checked)
            rawXML.AppendLine("<onup>91919994</onup>");
          else if (menItem.showMostRecent == displayMostRecent.music && cbEnableRecentMusic.Checked)
            rawXML.AppendLine("<onup>91919997</onup>");
          else if (menItem.showMostRecent == displayMostRecent.recordedTV && cbEnableRecentRecordedTV.Checked)
        ...
        case 1:
          ...
          if (menItem.subMenuLevel1ID > 0)
            ...
            rawXML.AppendLine("<ondown>" + (menItem.id + 800).ToString() + "</ondown>");
        ...
        case 9:
          ...
          rawXML.AppendLine("<animation effect=" + quote + "slide" + quote + " start=" + quote + "160,0" + quote + " end=" + quote + "480,0" + quote + " time=" + quote + duration + quote + " acceleration=" + quote + acceleration + quote + " reversible=" + quote + "false" + quote + ">Visible</animation>");
          rawXML.AppendLine("<animation effect=" + quote + "slide" + quote + " end=" + quote + "0,300" + quote + " time=" + quote + " 250" + quote + " acceleration=" + quote + " -0.1" + quote + " reversible=" + quote + "false" + quote + ">windowclose</animation>");
          rawXML.AppendLine("</control>");
          break;
        case 10:
        ...
        case 11:
          if (cbDropShadow.Checked)
          {
            ...
            rawXML.AppendLine("<posX>691</posX>");
            rawXML.AppendLine("<posY>" + (int.Parse(txtMenuPos.Text) + basicHomeValues.textYOffset + 1) + "</posY>");
            rawXML.AppendLine("<width>541</width>");
            rawXML.AppendLine("<height>50</height>");
            rawXML.AppendLine("<textcolor>" + dropShadowColor + "</textcolor>");
            rawXML.AppendLine("<font>#selectedFont</font>");
            rawXML.AppendLine("<align>center</align>");
